package com.daffa.appinventoryroom.adapter;
...
import com.daffa.appinventoryroom.R;
import com.daffa.appinventoryroom.RoomCreateActivity;
...
//        });
    ...
    private void onEditBarang(int position){
        context.startActivity(RoomCreateActivity.getActIntent((Activity) context)
